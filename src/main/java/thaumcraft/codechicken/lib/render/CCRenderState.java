...
// net.minecraft.client.renderer.OpenGlHelper /* TODO: OpenGlHelper removed */ removed
...
public class CCRenderState
{
    ...
    public static void changeTexture(String texture) {
        changeTexture(net.minecraft.resources.Identifier.parse(texture));
    }

    public static void changeTexture(Identifier texture) {
        // renderEngine.bindTexture removed; texture binding done via RenderSystem in modern MC
    }

    public static void draw() {
        // Tessellator.draw() removed in modern MC; drawing done via BufferUploader
    }
