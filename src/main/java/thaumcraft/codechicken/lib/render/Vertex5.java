...
public class Vertex5 implements Copyable<Vertex5>
{
    ...
    public String toString() {
        ...
        return "Vertex: (" + new BigDecimal(vec.getX(), cont) + ", " + new BigDecimal(vec.getY(), cont) + ", " + new BigDecimal(vec.getZ(), cont) + ") (" + new BigDecimal(uv.u, cont) + ", " + new BigDecimal(uv.v, cont) + ")";
    }
