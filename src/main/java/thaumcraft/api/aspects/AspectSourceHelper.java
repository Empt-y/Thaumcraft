...
public class AspectSourceHelper {
	...
	public static boolean drainEssentia(BlockEntity tile, Aspect aspect, Direction direction, int range) {
	    try {
	    	...
	    	LogManager.getLogger("THAUMCRAFT").warn("[Thaumcraft API] Could not invoke thaumcraft.common.lib.events.EssentiaHandler method drainEssentia");
	    }
		return false;
	}
	...
	public static boolean findEssentia(BlockEntity tile, Aspect aspect, Direction direction, int range) {
	    try {
	    	...
	    	LogManager.getLogger("THAUMCRAFT").warn("[Thaumcraft API] Could not invoke thaumcraft.common.lib.events.EssentiaHandler method findEssentia");
	    }
		return false;
	}
}
