...
public class FXVent2 extends Particle
{
    ...
    public FXVent2(Level par1World, double par2, double par4, double par6, double par8, double par10, double par12, int color) {
        ...
        rCol = (float) Mth.clamp(c.getRed() / 255.0f + random.nextGaussian() * 0.05, 0.0, 1.0);
        bCol = (float) Mth.clamp(c.getBlue() / 255.0f + random.nextGaussian() * 0.05, 0.0, 1.0);
        gCol = (float) Mth.clamp(c.getGreen() / 255.0f + random.nextGaussian() * 0.05, 0.0, 1.0);
        ...
        yo = y;
        zo = z;
        grav = (float)(random.nextGaussian() * 0.0075);
    }
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTick) {
        // Rendering stub - FXVent2 visual not ported to MC 26 render API
    }
