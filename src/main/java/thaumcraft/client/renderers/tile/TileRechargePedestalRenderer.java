...
public class TileRechargePedestalRenderer implements BlockEntityRenderer<TileRechargePedestal, TileRechargePedestalRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileRechargePedestal be, State state, float pt, Vec3 cam,
