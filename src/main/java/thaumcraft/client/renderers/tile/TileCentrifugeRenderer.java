...
public class TileCentrifugeRenderer implements BlockEntityRenderer<TileCentrifuge, TileCentrifugeRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileCentrifuge be, State state, float pt, Vec3 cam,
