...
public class TileDioptraRenderer implements BlockEntityRenderer<TileDioptra, TileDioptraRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileDioptra be, State state, float pt, Vec3 cam,
