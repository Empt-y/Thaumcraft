...
public class TileTubeValveRenderer implements BlockEntityRenderer<TileTubeValve, TileTubeValveRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileTubeValve be, State state, float pt, Vec3 cam,
