...
public class TileMirrorRenderer implements BlockEntityRenderer<TileMirror, TileMirrorRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileMirror be, State state, float pt, Vec3 cam,
