...
public class TileHungryChestRenderer implements BlockEntityRenderer<TileHungryChest, TileHungryChestRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileHungryChest be, State state, float pt, Vec3 cam,
