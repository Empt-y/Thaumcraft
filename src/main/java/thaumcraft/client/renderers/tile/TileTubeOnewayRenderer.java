...
public class TileTubeOnewayRenderer implements BlockEntityRenderer<TileTubeOneway, TileTubeOnewayRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileTubeOneway be, State state, float pt, Vec3 cam,
