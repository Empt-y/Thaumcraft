...
public class TilePatternCrafterRenderer implements BlockEntityRenderer<TilePatternCrafter, TilePatternCrafterRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TilePatternCrafter be, State state, float pt, Vec3 cam,
