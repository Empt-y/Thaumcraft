...
public class TileHoleRenderer implements BlockEntityRenderer<TileHole, TileHoleRenderer.State> {
    @Override
    public State createRenderState() { return new State(); }

    @Override
    public void extractRenderState(TileHole be, State state, float pt, Vec3 cam,
