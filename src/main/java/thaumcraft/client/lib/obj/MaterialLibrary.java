...
class MaterialLibrary extends Dictionary<String, Material>
{
    ...
    public void loadFromStream(Identifier loc) throws IOException {
    ...
    private org.joml.Vector3f parseVector3f(String data) {
        String[] parts = data.split(" ");
        return new org.joml.Vector3f(Float.parseFloat(parts[0]), Float.parseFloat(parts[1]), Float.parseFloat(parts[2]));
    }
