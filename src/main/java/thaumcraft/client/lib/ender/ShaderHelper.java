...
public class ShaderHelper
{
    ...
    public static void useShader(int shader, ShaderCallback callback) {
        ...
        if (shader != 0) {
            ...
            int tc = Minecraft.getInstance().player != null ? Minecraft.getInstance().player.tickCount : 0;
            ARBShaderObjects.glUniform1iARB(time, tc);
            if (callback != null) {
    ...
    public static boolean useShaders() {
        return false; // OpenGlHelper removed; shaders disabled in this port
    }
