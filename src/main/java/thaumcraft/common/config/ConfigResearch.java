...
public class ConfigResearch
{
    ...
    private static void initCategories() {
        ResearchCategories.registerCategory("BASICS", null, new AspectList().add(Aspect.PLANT, 5).add(Aspect.ORDER, 5).add(Aspect.ENTROPY, 5).add(Aspect.AIR, 5).add(Aspect.FIRE, 5).add(Aspect.EARTH, 3).add(Aspect.WATER, 5), Identifier.fromNamespaceAndPath("thaumcraft", "textures/item/thaumonomicon_cheat.png"), Identifier.fromNamespaceAndPath("thaumcraft", "textures/gui/gui_research_back_1.png"), ConfigResearch.BACK_OVER);
