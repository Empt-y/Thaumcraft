...
public class CardGlyphs extends TheorycraftCard
{
    ...
    public boolean activate(Player player, ResearchTableData data) {
        ...
        data.addTotal(s[player.getRandom().nextInt(s.length)], Mth.randomBetweenInclusive(player.getRandom(), 10, 20));
        data.addTotal("ELDRITCH", Mth.randomBetweenInclusive(player.getRandom(), 10, 20));
