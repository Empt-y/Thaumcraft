...
public class FocusMediumProjectile extends FocusMedium
{
    ...
    public NodeSetting[] createSettings() {
        ...
        return new NodeSetting[] { new NodeSetting("option", "focus.common.options", new NodeSetting.NodeSettingIntList(option, optionDesc), "FOCUSPROJECTILE"), new NodeSetting("speed", "focus.projectile.getSpeed()", new NodeSetting.NodeSettingIntRange(1, 5)) };
    }
