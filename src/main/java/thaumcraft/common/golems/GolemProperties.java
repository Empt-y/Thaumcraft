...
public class GolemProperties implements IGolemProperties
{
    ...
    static {
        ...
        GolemMaterial.register(new GolemMaterial("CLAY", new String[] { "MATSTUDCLAY" }, Identifier.fromNamespaceAndPath("thaumcraft", "textures/entity/golems/mat_clay.png"), 13071447, 10, 4, 2, new ItemStack(Blocks.TERRACOTTA, 1), new ItemStack(ItemsTC.mechanismSimple), new EnumGolemTrait[] { EnumGolemTrait.FIREPROOF }));
        ...
        GolemHead.register(new GolemHead("SMART_ARMORED", new String[] { "MINDBIOTHAUMIC", "GOLEMCOMBATADV" }, Identifier.fromNamespaceAndPath("thaumcraft", "textures/misc/golem/head_smartarmor.png"), new PartModel(Identifier.fromNamespaceAndPath("thaumcraft", "models/obj/golem_head_smart_armor.obj"), null, PartModel.EnumAttachPoint.HEAD), new Object[] { new ItemStack(ItemsTC.mind, 1), new ItemStack(ItemsTC.plate), "base", new ItemStack(Blocks.WHITE_WOOL) }, new EnumGolemTrait[] { EnumGolemTrait.SMART }));
